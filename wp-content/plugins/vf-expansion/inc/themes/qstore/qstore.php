...
require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/features/storepress-slider.php';
require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/features/storepress-product-cat.php';
require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/features/storepress-product.php';
require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/features/storepress-sponsor.php';
...
if ( ! function_exists( 'vf_expansion_storepress_frontpage_sections' ) ) :
	function vf_expansion_storepress_frontpage_sections() {	
		require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/sections/section-slider.php';
		require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/sections/section-product-cat.php';
		require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/sections/section-product.php';		
		require VF_EXPANSION_PLUGIN_DIR . 'inc/themes/qstore/sections/section-sponsor.php';		
    }
